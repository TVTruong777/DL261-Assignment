...
> Copy this template into the actual source-code repository for each assignment
> (one repo, or one folder per assignment inside a monorepo — either is fine,
> as long as every item below is present and correct).
